...
### 1. funzioni.py
Contiene tutte le funzioni operative del sistema. Gestisce:
...
1. Creare un nuovo paziente  
2. Registrare una nuova visita a un paziente  
3. Visualizzare l’elenco dei pazienti  
4. Mostrare tutte le visite di un paziente  
5. Uscire dal programma

Ogni voce del menù guida l’utente passo passo, richiedendo soltanto le informazioni essenziali come nome, cognome, data e descrizione della visita.
...
Il progetto è pensato per essere chiaro, leggibile e facilmente estendibile.  
In futuro si potrebbero aggiungere funzioni per modificare un paziente, cancellare una visita, filtrare i dati o generare report.
